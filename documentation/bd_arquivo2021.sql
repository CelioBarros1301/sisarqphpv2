...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/12/2021 às 18:40
...
--
-- Estrutura para tabela `tb_autorizados`
--
...
CREATE TABLE `tb_autorizados` (
  ...
  `lib_autorizado` varchar(1) COLLATE latin1_bin NOT NULL
...
--
-- Estrutura para tabela `tb_corredores`
--
...
--
-- Estrutura para tabela `tb_estantes`
--
...
CREATE TABLE `tb_menus` (
  ...
  `stat_pro` char(1) COLLATE latin1_bin NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
INSERT INTO `tb_menus` (`id_menu`, `seq_menu`, `nome_menu`, `icone_menu`, `href_menu`, `tipo_menu`, `lib_menu`, `stat_pro`) VALUES
(1, '01', 'Empresas', 'fa fa-building', 'empresa', '1', '1', '2'),
(2, '02', 'Autorizados', 'fa fa-unlock-alt', '#', '0', '1', '2'),
(4, '02.1', 'Cadastro', 'fa fa-users', 'autorizado', '1', '1', '2'),
(5, '02.2', 'Acesso Empresa', 'fa fa-key', 'setorautorizado&filtroAut=', '1', '1', '2'),
(6, '02.3', 'Acesso ao Sistema', 'fa fa-windows', 'acesso', '1', '1', '2'),
(7, '03', 'Localização', 'fa fa-globe', '#', '0', '1', '2'),
(8, '03.1', 'Arquivo', 'fa fa-archive', 'arquivo', '1', '1', '2'),
(9, '03.2', 'Corredor', 'fa fa-door-closed', 'corredor&filtroEmp=', '1', '1', '2'),
(10, '03.3', 'Estante', 'fa fa-th', 'estante&filtroEmp=', '1', '1', '2'),
(11, '03.4', 'Prateleira', 'fa fa-tasks', 'prateleira&filtroEmp=', '1', '1', '2'),
(13, '03.5', 'Caixa', 'fa fa-box-open', 'caixa&filtroEmp=', '1', '1', '2'),
(14, '04', 'Setor', 'fa fa-info-circle', 'setor', '1', '1', '2'),
(15, '05', 'Tipo Documento', 'fa fa-file-code', 'tipodocumento', '1', '1', '2'),
(16, '06', 'Documentos', 'fa fa-tasks', '#', '0', '1', '2'),
(17, '06.1', 'Documento', 'fa fa-file-alt', 'documento&filCodAut=&status=f', '1', '1', '2'),
(18, '06.2', 'Solicitaçao', '', '', '1', '1', '1'),
(19, '06.3', 'Destruir', 'fa fa-trash-alt', '', '1', '1', '1'),
(20, '06.4', 'Historico', 'fa fa-history', '', '1', '1', '1'),
(27, '07', 'Ferramenta', 'fa fa-cogs', '#', '0', '1', '2'),
(28, '07.1', 'Cadastro Usuario', 'fa fa-users', 'usuario', '1', '1', '2'),
(29, '07.2', 'Liberar Login', 'fa fa-unlock-alt', 'liberausuario', '1', '1', '2'),
(30, '07.3', 'SQL', 'fa fa-database', 'comandosql&status=f', '1', '1', '2'),
(31, '08', 'Historico Versões', 'fa fa-history', 'historico', '1', '1', '1'),
(32, '09', 'Contato', 'fa fa-id-card', '', '1', '1', '1'),
(33, '10', 'Sobre', 'fa fa-question-circle', 'sobre', '1', '1', '1'),
(34, '11', 'Sair', 'fa fa-power-off', 'sair', '1', '1', '2');

-- --------------------------------------------------------

--
-- Estrutura para tabela `tb_menu_usuarios`
--

CREATE TABLE `tb_menu_usuarios` (
...
--
-- Despejando dados para a tabela `tb_menu_usuarios`
--
...
--
-- Estrutura para tabela `tb_prateleiras`
--

CREATE TABLE `tb_prateleiras` (
  `cod_empresa` varchar(3) COLLATE latin1_bin NOT NULL,
  `cod_arquivo` varchar(2) COLLATE latin1_bin NOT NULL,
  `cod_corredor` varchar(3) COLLATE latin1_bin NOT NULL,
  `cod_estante` varchar(3) COLLATE latin1_bin NOT NULL,
...
--
-- Estrutura para tabela `tb_referencia`
--
...
--
-- Estrutura para tabela `tb_setores_autorizados`
--

CREATE TABLE `tb_setores_autorizados` (
...
--
-- Estrutura para tabela `tb_tipo_documentos`
--
...
CREATE TABLE `tb_usuarios` (
  ...
  `lib_usuario` varchar(1) COLLATE latin1_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
INSERT INTO `tb_usuarios` (`id_usu`, `log_usuario`, `sen_usuario`, `sta_usuario`, `per_usuario`, `nome_usuario`, `lib_usuario`) VALUES
(1, 'administrador@email.com', 'MTIzNDU2', '', '1', 'administrador', '1'),
(2, 'supervisor@email.com', 'MTIzNDU2', '', '1', 'supervisor', '1'),

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `view_documentos`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `view_documentos` (
...
--
-- Estrutura para view `view_documentos`
--
...
--
-- Índices de tabela `tb_autorizados`
--
...
--
-- Índices de tabela `tb_corredores`
--
...
ALTER TABLE `tb_empresas`
  ...
  ADD KEY `des_empresa` (`des_empresa`);

--
-- Índices de tabela `tb_estantes`
--
...
--
-- Índices de tabela `tb_setores_autorizados`
--
ALTER TABLE `tb_setores_autorizados`
  ADD PRIMARY KEY (`id_setaut`),
  ADD KEY `fk_setor_setaut` (`cod_empresa`,`cod_setor`),
  ADD KEY `fk_autorizado_setaut` (`cod_autorizado`);
...
--
-- Índices de tabela `tb_tipo_documentos`
--
...
ALTER TABLE `tb_usuarios`
  ...
  ADD UNIQUE KEY `log_usuario` (`log_usuario`);
...
--
-- AUTO_INCREMENT de tabela `tb_menu_usuarios`
--
ALTER TABLE `tb_menu_usuarios`
  MODIFY `id_menu_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT de tabela `tb_setores_autorizados`
--
ALTER TABLE `tb_setores_autorizados`
  MODIFY `id_setaut` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de tabela `tb_usuarios`
--
ALTER TABLE `tb_usuarios`
  MODIFY `id_usu` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificado do Usuario', AUTO_INCREMENT=26;
...
--
-- Restrições para tabelas `tb_menu_usuarios`
--
ALTER TABLE `tb_menu_usuarios`
...
--
-- Restrições para tabelas `tb_prateleiras`
--
ALTER TABLE `tb_prateleiras`
...
--
-- Restrições para tabelas `tb_setores_autorizados`
--
ALTER TABLE `tb_setores_autorizados`
...
--
-- Restrições para tabelas `tb_tipo_documentos`
--
ALTER TABLE `tb_tipo_documentos`
